...
const OtpScreen = () => {
  ...
  const verifyOtp = async () => {
    try {
      const response = await axios.post('http://127.0.0.1:8000/api/otpauth/verify-otp/', { email, otp });
  ...
  return (
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20 }}>
      ...
      <TextInput
        style={{ borderWidth: 1, borderColor: 'gray', padding: 10, width: '80%', marginBottom: 20 }}
